...
public class BlackActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    case R.id.tv_pop_contact:
                        Toast.makeText(BlackActivity.this, "contact", Toast.LENGTH_SHORT).show();
                        contactAdd();
                        break;
                    case R.id.tv_pop_phone:
                        Toast.makeText(BlackActivity.this, "phone", Toast.LENGTH_SHORT).show();
                        phoneAdd();
                        break;
                    case R.id.tv_pop_sms:
                        Toast.makeText(BlackActivity.this, "sms", Toast.LENGTH_SHORT).show();
                        smsAdd();
                        break;
                    case R.id.tv_pop_shoudong:
                        Toast.makeText(BlackActivity.this, "shoudong", Toast.LENGTH_SHORT).show();
                        shoudongAdd();
                        break;
                }
                mPopMenu.dismiss();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (data != null) {
            ...
            Toast.makeText(BlackActivity.this, "123", Toast.LENGTH_SHORT).show();
        }
        ...
        bt_confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(number)) {
                    Toast.makeText(BlackActivity.this, "不能为空喔!", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (!cb_phone.isChecked() && !cb_sms.isChecked()) {
                    Toast.makeText(BlackActivity.this, "至少要选择一种拦截模式", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private class BlackAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            BlackBean bean = (BlackBean) getItem(position);
